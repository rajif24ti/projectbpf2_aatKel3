...
export default function GiziProduksi() {
  ...
  // Cari data produksi
  const produksi = dataProduksiAwal.find((item) => item.id === Number(id));
  ...
  if (!produksi) {
    return (
      <div className="p-6 text-center">Data produksi tidak ditemukan.</div>
    );
  }
    ...
    <main className="grow">
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-semibold">{produksi.tanggal}</p>
            </div>

            <div>
              <p className="text-sm text-gray-500">Menu</p>
              <p className="font-semibold">{produksi.menu}</p>
            </div>

            <div>
              <p className="text-sm text-gray-500">Jumlah Porsi</p>
              <p className="font-semibold">{produksi.porsi} Porsi</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
          <h2 className="text-lg font-semibold mb-4">Informasi Gizi</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div className="p-4 rounded-xl bg-rose-50">
              <p className="text-sm text-gray-500">Serat</p>
